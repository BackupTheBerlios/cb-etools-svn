 ...
 *
 * $Revision: 4909 $
 * $Id: autorevision.cpp 4909 2008-02-27 13:15:26Z mortenmacfly $
 * $HeadURL: svn+ssh://tiwag@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/build_tools/autorevision/autorevision.cpp $
 */
...
bool WriteOutput(const string& outputFile, string& revision, string& date)
{
    ...
    if(do_wx) {
        fprintf(header, "\tconst wxString svnRevisionTag(_T(\"tiwagsvnrevtag\"));\n"); // NOTE (tiwag#1#): local modification for my get_cb_rev version detection
